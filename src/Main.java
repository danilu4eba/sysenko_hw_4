...
public class Main {
    ...
    public static int heroesHill = 1;
    ...
    public static void currentHeroesHill(){
        Random random = new Random();
            int randomIndex = random.nextInt(heroesHealth.length-1);
            if (heroesHealth[randomIndex]>0 && heroesHealth[3]>0){
                 heroesHealth[randomIndex] = heroesHealth[randomIndex] + heroesHill;
                System.out.println( "heroesHill: " + heroesHill);
